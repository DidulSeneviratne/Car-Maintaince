...
import com.universl.didul.car_maintenance.edit_odometer;

import java.util.ArrayList;
public class CustomAdapter5 extends RecyclerView.Adapter<CustomAdapter5.MyViewHolder> {
    private Context context;
    private Activity activity;
    private ArrayList activity_oid, activity_odate, activity_oo, activity_onotes, activity_oveh;
    public CustomAdapter5(Activity activity, Context context, ArrayList oid, ArrayList odate, ArrayList oo, ArrayList onotes, ArrayList oveh){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.model.setText(String.valueOf(activity_oo.get(adapterPosition)));
