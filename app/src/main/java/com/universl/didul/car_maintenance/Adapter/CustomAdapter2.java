...
public class CustomAdapter2 extends RecyclerView.Adapter<CustomAdapter2.MyViewHolder> {
    ...
    private ArrayList activity_fid, activity_fdate, activity_fodo, activity_fqua, activity_fprice, activity_ftot, activity_fsta, activity_fnotes, activity_fveh;
    private ArrayList<byte[]> activity_frep;
    public CustomAdapter2(Activity activity, Context context, ArrayList fid, ArrayList fdate, ArrayList fodo, ArrayList fqua, ArrayList fprice, ArrayList ftot, ArrayList fsta, ArrayList fnotes, ArrayList fveh, ArrayList frep){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.model.setText(String.valueOf(activity_fqua.get(adapterPosition)));
        holder.year.setText(String.valueOf(activity_ftot.get(adapterPosition)));
