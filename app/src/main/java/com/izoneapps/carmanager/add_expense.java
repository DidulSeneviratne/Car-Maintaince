...
public class add_expense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='#FFFFFF' size='10'>" + "&nbsp;&nbsp;Add Expenses" +"</font>"));
            ...
            public void onClick(View v) {
                try {
                    if (date.getText().toString().equals("") && odometer.getText().toString().equals("") && service.getText().toString().equals("")
                        ...
                        Toast.makeText(add_expense.this, "Please fill all the data", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(add_expense.this, "Enter valid data", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void saveEventAction() {
        service_records myDB = new service_records(add_expense.this);
        odometer_records myDB1 = new odometer_records(add_expense.this);
        ...
        myDB.insertData(sharedId, dates, odometers, services, totals, stations, notes, vehicle, bitmap1);
