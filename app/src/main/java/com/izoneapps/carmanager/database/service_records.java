...
public class service_records extends SQLiteOpenHelper {
    private Context context;
    private static final String DATABASE_NAME = "s_records.db";
    ...
    public service_records(Context context) {
    ...
    public void insertData(String uuid, String date, String odometer, String service, String total, String station, String notes, String vehicle, Bitmap img){
    ...
    public Cursor readAllData0(String vehicle) {
    ...
    public Cursor readAllData1(String vehicle) {
        String query = "SELECT * FROM " + TABLE_NAME + " WHERE " + COLUMN_SERVICE + " LIKE '%service%'" + " AND " + COLUMN_VEHICLES + " = " + "'" + vehicle + "'";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = null;
        if (db != null) {
            cursor = db.rawQuery(query, null);
    ...
    public Cursor readAllData2(String vehicle) {
        String query = "SELECT * FROM " + TABLE_NAME + " WHERE " + COLUMN_SERVICE + " NOT LIKE '%service%'" + " AND " + COLUMN_VEHICLES + " = " + "'" + vehicle + "'";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = null;
        if (db != null) {
            cursor = db.rawQuery(query, null);
    ...
    public Cursor readAllData3(String id){
    ...
    public long updateData(String uuid, String row_id, String date, String odometer, String service, String total, String station, String notes, String vehicle, Bitmap img){
