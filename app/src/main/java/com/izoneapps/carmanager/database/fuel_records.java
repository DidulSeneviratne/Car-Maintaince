...
public class fuel_records extends SQLiteOpenHelper {
    ...
    public void insertData(String uuid, String date, String odometer, String quantity, String price_per_liter, String total, String station, String notes, String vehicle, Bitmap img){
    ...
    public Cursor readAllData2(String id){
    ...
    public long updateData(String uuid, String row_id, String date, String odometer, String quantity, String price_per_liter, String total, String station, String notes, String vehicle, Bitmap img){
