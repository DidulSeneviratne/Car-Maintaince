...
public class edit_trip extends AppCompatActivity {
    ...
    String id, uuid, ddates, dodometers, dlocations, adates, aodometers, alocations, distances, times, speeds, parks, notes, vehicle;
    int dodo, aodo, km;
    double hour, avgs;
    String location, loc;
    double lat = 28.7041;
    ...
    void updateData(){
        ...
        odometer_records myDB1 = new odometer_records(edit_trip.this);
        ...
        myDB.updateData(id, uuid, ddates, dodometers, dlocations, adates, aodometers, alocations, distances, times, speeds, parks, notes, vehicle);
        myDB1.updateData1(uuid, adates, aodometers, notes, vehicle);
        finish();
    ...
    private void loadLocation() {
        if (Geocoder.isPresent()) {
            LayoutInflater inflater = LayoutInflater.from(edit_trip.this);
            ...
            AlertDialog dialog = new AlertDialog.Builder(edit_trip.this)
                    .setView(dialogView)
