...
import com.izoneapps.carmanager.edit_expense_reminder;
...
public class CustomAdapter7 extends RecyclerView.Adapter<CustomAdapter7.MyViewHolder>{
    ...
    private ArrayList activity_id, activity_name, activity_km, activity_days, activity_veh, activity_enable;
    public CustomAdapter7(Activity activity, Context context, ArrayList id, ArrayList name, ArrayList km, ArrayList days, ArrayList veh, ArrayList enable){
    ...
    @NonNull
    @Override
    public CustomAdapter7.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.row1, parent, false);
        return new CustomAdapter7.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final CustomAdapter7.MyViewHolder holder, int position) {
        ...
        holder.year.setText(String.valueOf(activity_days.get(adapterPosition)) + " d.");
        holder.fuel.setText(String.valueOf(activity_km.get(adapterPosition)) + " l");

        //Recyclerview onClickListener
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, edit_expense_reminder.class);
