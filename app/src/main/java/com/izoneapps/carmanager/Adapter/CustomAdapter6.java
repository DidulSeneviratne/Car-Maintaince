...
import com.izoneapps.carmanager.edit_service_reminder;
...
public class CustomAdapter6 extends RecyclerView.Adapter<CustomAdapter6.MyViewHolder> {
    ...
    private ArrayList activity_id, activity_uuid, activity_name, activity_km, activity_days, activity_enable, activity_lkm, activity_ldate, activity_veh;
    public CustomAdapter6(Activity activity, Context context, ArrayList id, ArrayList uuid, ArrayList name, ArrayList km, ArrayList days, ArrayList enable, ArrayList lkm, ArrayList ldate, ArrayList veh){
        this.activity = activity;
        this.context = context;
        this.activity_id = id;
        this.activity_uuid = uuid;
    ...
    public void onBindViewHolder(@NonNull final CustomAdapter6.MyViewHolder holder, int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("uuid", String.valueOf(activity_uuid.get(adapterPosition)));
