...
import com.izoneapps.carmanager.edit_service;
...
public class CustomAdapter3 extends RecyclerView.Adapter<CustomAdapter3.MyViewHolder> {
    ...
    private ArrayList activity_sid, activity_suid, activity_sdate, activity_sodo, activity_ss, activity_stot, activity_sta, activity_snot, activity_sveh;
    private ArrayList<byte[]> activity_srep;
    public CustomAdapter3(Activity activity, Context context, ArrayList sid, ArrayList suid, ArrayList sdate, ArrayList sodo, ArrayList ss, ArrayList stot, ArrayList sta, ArrayList snot, ArrayList sveh, ArrayList srep){
        this.activity = activity;
        this.context = context;
        this.activity_sid = sid;
        this.activity_suid = suid;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        try {
            ...
            holder.year.setText(String.valueOf(activity_stot.get(adapterPosition)) + " LKR");
            ...
            holder.mainLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("uuid", String.valueOf(activity_suid.get(adapterPosition)));
