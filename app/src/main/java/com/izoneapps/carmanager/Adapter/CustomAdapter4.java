...
import com.izoneapps.carmanager.edit_trip;
...
public class CustomAdapter4 extends RecyclerView.Adapter<CustomAdapter4.MyViewHolder> {
    ...
    private ArrayList activity_tid, activity_tuid, activity_ddate, activity_dodo, activity_dloc, activity_adate, activity_aodo, activity_aloc, activity_tdis, activity_tt, activity_tavg, activity_tpark, activity_tnot, activity_tveh;
    public CustomAdapter4(Activity activity, Context context, ArrayList tid, ArrayList tuid, ArrayList ddate, ArrayList dodo, ArrayList dloc, ArrayList adate, ArrayList aodo, ArrayList aloc, ArrayList tdis, ArrayList tt, ArrayList tavg, ArrayList tpark, ArrayList tnot, ArrayList tveh){
        this.activity = activity;
        this.context = context;
        this.activity_tid = tid;
        this.activity_tuid = tuid;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.year.setText(String.valueOf(activity_tdis.get(adapterPosition)) + " km");
        holder.fuel.setText(String.valueOf(activity_tt.get(adapterPosition)) + " h");
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("uuid", String.valueOf(activity_tuid.get(adapterPosition)));
